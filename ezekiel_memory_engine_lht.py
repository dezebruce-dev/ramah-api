...
class Layer0Scripture:
    ...
    def load_kjv(self, bible_path: str = '/mnt/project/pg10.txt'):
        ...
        try:
            ...
            print(f"Warning: Bible file not found at {bible_path}")
            print("Layer 0 will be empty - load Scripture manually")
            return 0
